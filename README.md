...
- [`career-grill`](skills/career-grill/README.md) — собирает карьерную легенду и паспорт для CV по одной роли;
...
Рекомендуемый порядок: сначала собрать роль через `career-grill`, затем передать `career-cv` список ключевых фраз и подготовить секцию резюме. Интервью-вопросы, готовые ответы и mock-интервью этими skills не составляются.
